...
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-smooth ${scrolled ? "bg-card/95 backdrop-blur-md border-b border-border shadow-warm-sm" : "bg-transparent"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16 md:h-20", children: [
            ...
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: `font-display font-bold tracking-[0.25em] text-xl transition-smooth ${scrolled ? "text-primary" : "text-card"}`,
                    children: "SADHYA"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: `hidden sm:block h-4 w-px transition-smooth ${scrolled ? "bg-border" : "bg-card/40"}`
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: `hidden sm:block font-body text-xs tracking-[0.1em] uppercase transition-smooth ${scrolled ? "text-muted-foreground" : "text-card/70"}`,
                    children: "Kerala Table"
                  }
                )
              ]
            }
            ...
            "nav",
            {
              ...
              children: navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  className: `font-body text-sm tracking-wide transition-smooth hover:opacity-70 ${scrolled ? "text-foreground" : "text-card/90"}`,
                  children: link.label
                },
                link.href
              ))
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                variant: "outline",
                size: "sm",
                className: `hidden md:inline-flex font-body tracking-wider text-xs transition-smooth ${scrolled ? "border-accent text-accent hover:bg-accent hover:text-accent-foreground" : "border-card/60 text-card hover:bg-card/10"}`,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: `md:hidden p-2 rounded-md transition-smooth ${scrolled ? "text-foreground" : "text-card"}`,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: `md:hidden transition-all duration-300 overflow-hidden ${menuOpen ? "max-h-96 opacity-100" : "max-h-0 opacity-0"} bg-card/98 backdrop-blur-md border-t border-border`,
...
const hostname = typeof window !== "undefined" ? window.location.hostname : "sadhya.app";
...
const highlights = [
  {
    ...
    description: "Each gathering celebrates a distinct region of Kerala — from the backwaters of Alleppey to the spice hills of Wayanad. Every menu is a journey."
  },
  {
    icon: Sprout,
    title: "Seasonal Ingredients",
    description: "Sourced from small Kerala farms and trusted vendors. We cook with what the season offers — nothing more, nothing less."
  },
  {
    icon: BookOpen,
    title: "Cultural Storytelling",
    description: "Meals come with stories. The history of Sadya, the significance of each dish, the people who grew it — food as living culture."
  }
];
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: titleRef, className: "section-reveal text-center mb-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs tracking-[0.3em] uppercase text-accent mb-4", children: "Our Story" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-4xl sm:text-5xl lg:text-6xl text-foreground font-bold leading-tight mb-6", children: [
            "A Cultural",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic font-light", children: "Culinary Journey" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider max-w-xs mx-auto" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: imageRef, className: "section-reveal", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-[4/5] rounded-lg overflow-hidden shadow-warm-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-4 -right-4 w-24 h-24 border-r-2 border-b-2 border-accent/30 rounded-br-lg" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-4 -left-4 w-24 h-24 border-l-2 border-t-2 border-accent/30 rounded-tl-lg" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-6 -right-6 bg-card shadow-warm-lg rounded-md px-4 py-3 hidden lg:block", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-2xl font-bold text-accent leading-none", children: "12" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-muted-foreground mt-1", children: "Seats Only" })
            ] })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: contentRef, className: "section-reveal space-y-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-lg sm:text-xl leading-relaxed text-foreground/80", children: "SADHYA is an intimate dining experience with a curated menu, shared seating & conversations that flow as naturally as the coconut toddy." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-base leading-relaxed text-muted-foreground", children: "Born from a love of Kerala's extraordinary food culture, we gather people around a banana leaf to share not just a meal, but a moment in time. Every event is different. Every menu is a discovery." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: highlights.map(({ icon: Icon2, title, description }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: "flex gap-5",
                "data-ocid": `about.highlight_${title.split(" ")[0].toLowerCase()}`,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 w-10 h-10 rounded-full bg-accent/10 flex items-center justify-center mt-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 18, className: "text-accent" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-base font-semibold text-foreground mb-1", children: title }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm leading-relaxed text-muted-foreground", children: description })
                  ] })
                ]
              },
              title
...
Notes: ${form.notes}` : ""}`;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: titleRef, className: "section-reveal text-center mb-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs tracking-[0.3em] uppercase text-accent mb-4", children: "Secure Your Seat" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-4xl sm:text-5xl lg:text-6xl text-foreground font-bold leading-tight mb-6", children: [
            "Pre-Booking ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic font-light", children: "Essential" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-base text-muted-foreground max-w-md mx-auto leading-relaxed", children: "Seats at SADHYA are limited and in demand. Reserve yours before they're gone." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider max-w-xs mx-auto mt-8" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 max-w-5xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2 space-y-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-semibold text-foreground mb-4", children: "Direct Contact" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground mb-5 leading-relaxed", children: "Prefer to speak with us directly? Reach out on WhatsApp or call during the hours below." }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
                  href: "https://wa.me/919021445900",
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-accent/10 flex items-center justify-center group-hover:bg-accent/20 transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SiWhatsapp, { size: 18, className: "text-accent" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-muted-foreground", children: "WhatsApp" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-base font-semibold text-foreground", children: "+91 90214 45900" })
                    ] })
                  ]
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-lg p-6 shadow-warm-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 14, className: "text-accent" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs tracking-[0.1em] uppercase text-muted-foreground", children: "Available Hours" })
              ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-3", children: submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-accent/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 32, className: "text-accent" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl font-bold text-foreground mb-3", children: "Request Sent!" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-base text-muted-foreground leading-relaxed", children: "Your WhatsApp message has been prepared. We'll confirm your seat within 24 hours. See you at the table!" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
            ...
            "form",
            {
              ...
              noValidate: true,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-semibold text-foreground", children: "Reserve Your Seat" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider" }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-2 sm:col-span-1 space-y-1.5", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "select",
                      {
                        ...
                        children: eventOptions.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: opt, children: opt }, opt))
                      }
                    )
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-2 sm:col-span-1 space-y-1.5", children: [
                    ...
                    errors.guests && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Label,
                    {
                      ...
                      className: "font-body text-xs tracking-[0.1em] uppercase text-muted-foreground",
                      children: "Dietary notes / Message"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "textarea",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-muted-foreground text-center leading-relaxed", children: "Submitting opens WhatsApp with your booking details pre-filled. We'll confirm your seat within 24 hours." })
              ]
            }
          ) })
        ] })
...
const events = [
  {
    ...
    description: "A full traditional Kerala Sadhya — 28 dishes on a banana leaf, served in the exact order prescribed by centuries of culinary tradition. A masterclass in simplicity and abundance.",
  ...
  },
  {
    ...
    description: "A journey through North Kerala — the biryanis, the seafood curries, the coconut chutneys of Kozhikode. A Mappila-inspired spread that tells the story of trade winds and spice routes.",
    location: "Pune, Maharashtra",
  ...
  },
  {
    ...
    time: "7:00 PM – 10:30 PM",
    theme: "Monsoon Table",
    description: "Timed for the first Keralan rains — a menu that celebrates the richness of the monsoon harvest. Seasonal greens, jackfruit curries, and steaming kanji.",
    location: "Pune, Maharashtra",
...
function EventsSection() {
  ...
  const handleBook = () => {
    var _a2;
    (_a2 = document.querySelector("#booking")) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth" });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: titleRef, className: "section-reveal text-center mb-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs tracking-[0.3em] uppercase text-accent mb-4", children: "Upcoming Gatherings" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-4xl sm:text-5xl lg:text-6xl text-foreground font-bold leading-tight mb-6", children: [
            "Join the Next ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic font-light", children: "Table" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground", children: "Pre-booking is essential. Seats go fast." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider max-w-xs mx-auto mt-8" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", "data-ocid": "events.list", children: events.map((event, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            "data-ocid": `events.event.${index2 + 1}`,
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 space-y-4", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl sm:text-3xl font-bold text-foreground", children: event.theme }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm leading-relaxed text-muted-foreground max-w-2xl", children: event.description }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-4 pt-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-muted-foreground", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarDays, { size: 14, className: "text-accent" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-sm", children: event.date })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-muted-foreground", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 14, className: "text-accent" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-sm", children: event.time })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-muted-foreground", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 14, className: "text-accent" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-sm", children: event.location })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-muted-foreground", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { size: 14, className: "text-accent" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-sm", children: event.seats })
                  ] })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  onClick: handleBook,
                  "data-ocid": `events.book_button.${index2 + 1}`,
...
const features = [
  {
    ...
    description: "This is not booking a table for two — you join a shared long table with fellow food lovers. Strangers become stories."
  },
  {
    icon: CalendarCheck,
    number: "02",
    title: "Pre-Booking Required",
    description: "Every seat is reserved in advance. We prepare precisely for each guest — no walk-ins, no compromises on quality."
  },
  {
    icon: Clock,
    number: "03",
    title: "Limited Seats Always",
    description: "A maximum of 12–16 guests per event. This is intentional. Intimacy and attention are the foundations of the experience."
  },
  {
    icon: Star,
    number: "04",
    title: "A Curated Journey",
    description: "Each event has a theme — a region, a season, a tradition. The menu, the stories, and the setting are all crafted with intention."
  }
];
function ExperienceSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: titleRef, className: "section-reveal text-center mb-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs tracking-[0.3em] uppercase text-accent mb-4", children: "How It Works" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-4xl sm:text-5xl lg:text-6xl text-foreground font-bold leading-tight mb-6", children: [
            "The SADHYA",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic font-light", children: "Experience" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-base text-muted-foreground max-w-xl mx-auto leading-relaxed", children: "A supper club unlike any you've attended. Every detail is curated, every seat is earned." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider max-w-xs mx-auto mt-8" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: features.map(({ icon: Icon2, number, title, description }, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                "data-ocid": `experience.feature.${index2 + 1}`,
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-4 right-4 font-display text-5xl font-black text-accent/8 leading-none select-none pointer-events-none", children: number }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full bg-accent/10 flex items-center justify-center mb-6 group-hover:bg-accent/20 transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 22, className: "text-accent" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-semibold text-foreground mb-3 leading-snug", children: title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm leading-relaxed text-muted-foreground", children: description })
                ]
              },
              number
...
function GallerySection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: titleRef, className: "section-reveal text-center mb-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs tracking-[0.3em] uppercase text-accent mb-4", children: "Moments at the Table" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-4xl sm:text-5xl lg:text-6xl text-foreground font-bold leading-tight mb-6", children: [
            "The SADHYA ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic font-light", children: "Gallery" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider max-w-xs mx-auto" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: galleryImages.map((image, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                "data-ocid": `gallery.image.${index2 + 1}`,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center font-body text-sm italic text-muted-foreground mt-8", children: [
          "Follow us on",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              backgroundImage: "url('/assets/generated/sadhya-hero.dim_1920x1080.jpg')"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-primary/75" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-banana-leaf-pattern opacity-40" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 right-0 h-40 bg-gradient-to-t from-background to-transparent" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/3 left-8 lg:left-16 w-px h-24 bg-gradient-to-b from-transparent via-accent/40 to-transparent hidden md:block" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/3 right-8 lg:right-16 w-px h-24 bg-gradient-to-b from-transparent via-accent/40 to-transparent hidden md:block" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 text-center px-6 max-w-4xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: ctaRef, className: "section-reveal", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-xs tracking-[0.3em] uppercase text-accent mb-8 inline-flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-8 h-px bg-accent/60" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm sm:text-base tracking-[0.25em] uppercase text-accent mb-6", children: "The Kerala Table Supper Club" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-4 mb-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-px bg-gradient-to-r from-transparent to-accent/50" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1.5 h-1.5 rounded-full bg-accent/60" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-24 h-px bg-accent/50" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-1.5 h-1.5 rounded-full bg-accent/60" }),
...
const dishes = [
  {
    name: "Parippu Curry",
    description: "Slow-cooked lentils tempered with ghee, mustard seeds & dried red chilli. The soul of every Sadhya.",
    category: "Rice & Curry",
    tag: "Classic"
  },
  {
    name: "Avial",
    description: "Mixed vegetables in a thick coconut-curd gravy, finished with fragrant curry leaves and coconut oil.",
    category: "Vegetable",
    tag: "Heritage"
  },
  {
    name: "Sambar",
    description: "Tamarind-laced lentil broth with pearl onions and drumstick. The second pour after parippu.",
    category: "Rice & Curry",
    tag: "Classic"
  },
  {
    name: "Thoran",
    description: "Finely chopped seasonal vegetables stir-fried with shredded coconut and turmeric.",
    category: "Dry Dish",
    tag: "Seasonal"
  },
  {
    name: "Olan",
    description: "White pumpkin and cowpeas in a delicate coconut milk broth — elegance in simplicity.",
    category: "Curry",
    tag: "Signature"
  },
  {
    name: "Payasam",
    description: "Palada payasam — rice flakes in sweetened milk, slow reduced to a dreamy richness.",
    category: "Dessert",
    tag: "Sweet"
  },
  {
    name: "Rasam",
    description: "Peppery, bright tomato rasam — the digestive finale, poured warm over rice.",
    category: "Rasam",
    tag: "Classic"
  },
  {
    name: "Pappadom & Pickles",
    description: "Hand-rolled pappadom served with raw mango pickle and sweet lime pickle.",
    category: "Sides",
    tag: "Essential"
  }
];
...
function MenuSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: titleRef, className: "section-reveal text-center mb-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs tracking-[0.3em] uppercase text-accent mb-4", children: "The Feast" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-4xl sm:text-5xl lg:text-6xl text-foreground font-bold leading-tight mb-6", children: [
            "A Sadhya on ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic font-light", children: "Banana Leaf" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-base text-muted-foreground max-w-xl mx-auto leading-relaxed", children: "Twenty-eight dishes. One banana leaf. A meal that takes four hours to cook and twenty minutes to eat — if you're rushing. We don't rush." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider max-w-xs mx-auto mt-8" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: dishes.map((dish, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                "data-ocid": `menu.dish.${index2 + 1}`,
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-base font-semibold text-foreground leading-snug", children: dish.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm italic text-muted-foreground", children: "Menu varies by event theme and season. Every item is prepared fresh on the day." }) })
      ] })
    }
  );
}
const testimonials = [
  {
    quote: "I've eaten at Michelin-starred restaurants across three continents. Nothing prepared me for the intimacy and warmth of the Sadhya table. It wasn't just dinner — it was a memory.",
    name: "Ananya Krishnaswamy",
    title: "Food writer, Mumbai",
    initials: "AK"
  },
  {
    quote: "The avial alone was worth the trip from Bangalore. But it was the story behind the meal — the farmer who grew the coconuts, the region the menu honoured — that stayed with me.",
    name: "Rohan Menon",
    title: "Architect & food enthusiast",
    initials: "RM"
  },
  {
    quote: "I brought my mother to the last event. She grew up in Thrissur and hadn't tasted food like this in thirty years. She wept. I wept. The whole table felt it.",
...
function TestimonialsSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 opacity-5 pointer-events-none", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 left-0 w-64 h-64 border border-accent/40 rounded-full -translate-x-1/2 -translate-y-1/2" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 right-0 w-96 h-96 border border-accent/30 rounded-full translate-x-1/3 translate-y-1/3" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/2 left-1/2 w-32 h-32 border border-accent/20 rounded-full -translate-x-1/2 -translate-y-1/2" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-7xl mx-auto px-6 lg:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: titleRef, className: "section-reveal text-center mb-16", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs tracking-[0.3em] uppercase text-accent mb-4", children: "Voices from the Table" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6 text-primary-foreground", children: [
              "What Our ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: testimonials.map((testimonial, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
